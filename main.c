...
#define FT_BZERO_TEST 1
#define FT_STRCAT_TEST 1
#define FT_ISALPHA_TEST 1
#define FT_ISDIGIT_TEST 1
#define FT_ISALNUM_TEST 1
#define FT_ISASCII_TEST 1
#define FT_ISPRINT_TEST 1
#define FT_PUTS_TEST 1
#define FT_STRLEN_TEST 1
#define FT_TOUPPER_TEST 1
#define FT_TOLOWER_TEST 1
#define FT_MEMSET_TEST 1
#define FT_MEMCPY_TEST 1
#define FT_STRDUP_TEST 1
#define FT_CAT_TEST 1
#define FT_ABS_TEST 1
#define FT_ITOA_TEST 1
#define FT_MEMCMP_TEST 1
#define FT_MEMMOVE_TEST 1
#define FT_STRCMP_TEST 1
...
const char      *__empty_string__ = "",
                ...
                *__ft_strlen_str__ = "TROP LONG LE STRING DE OOOOOOOOOOOOOUUUUUUUUUFFFFFFF";
...
# define TEST_STR "ft_isalpha"
    ...
    printf(" - \x1b[1;33m%s, status: \x1b[0m%s\x1b[0m\n", TEST_STR, success ? "\x1b[32mSUCCESS" : "\x1b[1;34mFAIL");
# undef TEST_STR
#endif
...
# define TEST_STR "ft_puts"
    ...
    printf(" - \x1b[1;33mTEST1: \x1b[0m%s\x1b[0m\n", success ? "\x1b[32mSUCCESS" : "\x1b[1;34mFAIL");
    printf(" - \x1b[1;33mTEST2: Empty string\x1b[0m\n");
    printf(" - Test string: \"%s\"\n - Output using puts: ", __empty_string__);
...
# define TEST_STR "ft_strlen"
    ...
    printf(" - String length using ft_strlen: %lu\n", ft_st_ret_value);
    success2 = st_ret_value == ft_st_ret_value ? 1 : 0;
    printf(" - \x1b[1;33mTEST2: \x1b[0m%s\x1b[0m\n", success2 ? "\x1b[32mSUCCESS" : "\x1b[1;34mFAIL");
    printf(" - \x1b[1;33m%s, result: \x1b[0m%s\x1b[0m\n", TEST_STR, success && success2 ? "\x1b[32mSUCCESS" : "\x1b[1;34mFAIL");
# undef TEST_STR
#endif
...
# define TEST_STR "ft_strdup"
    ...
    char *__strdup__ = strdup(__ft_strdup_str__);
    printf(" - Duping string with ft_strdup...\n");
    char *__ft_strdup__ = ft_strdup(__ft_strdup_str__);
